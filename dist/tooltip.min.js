		...
		function init() {
			...
			function showTooltip(event) {
				if (event.target.closest(tooltipOptions.tooltip)) {
					var elToTooltip = event.target.closest(tooltipOptions.tooltip);
					var wWidth = window.innerWidth;
					var rect = elToTooltip.getBoundingClientRect();
					var pos = rect.right + elToTooltip.scrollWidth > wWidth ? 'right' : 'left';
